...
<head>
    ...
    <script src="https://kit.fontawesome.com/bddbdccbee.js" crossorigin="anonymous"></script>
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<%} else {%>
									...
									<li class="btn-cta"><a href="agreement.do"><span>회원가입</span></a></li>
								<%} %>
				   			...
				   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
				   				<div class="slider-text-inner">
				   					<h1>빌리지심포니는 최고의 강사진 여러분들을 언제나 기다리고 있습니다.</h1>
										<h2>중계 수수료 없이, 최고의 대우로 여러분들을 맞이합니다</h2>
										<p><a class="btn btn-primary btn-lg btn-learn" href="#" onClick="lessoncreate();">강사등록하기</a></p>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
				   			...
				   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
				   				<div class="slider-text-inner">
				   					<h1>이달의 베스트 학생 후기를 만나보세요</h1>
										<h2>July 2022 Best Villagers </h2>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6 animate-box">
						<div class="course">
							<a href="#" class="course-img" style="background-image: url(images/piano2.jpg);">
							</a>
							<div class="desc">
								<h3><a href="#">즐거운 클래식 피아노</a></h3>
								<p>클래식 피아노를 즐겁고 쉽게 배울 수 있습니다. 어렵게만 느껴졌던 클래식이라는 장르를 즐겁고 쉽게 가르쳐드립니다. 온/오프라인 수업 가능합니다.</p>
								<span><a href="courses.do" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
							</div>
						</div>
					</div>
					<div class="col-md-6 animate-box">
						<div class="course">
							<a href="#" class="course-img" style="background-image: url(images/piano_1.jpg);">
							</a>
							<div class="desc">
					...
					<div class="col-md-6 animate-box">
						<div class="course">
							<a href="#" class="course-img" style="background-image: url(images/acou_t4.jpg);">
							</a>
							<div class="desc">
								<h3><a href="#">로맨틱한 어쿠스틱 기타</a></h3>
								<p>가슴을 떨리게 만드는 어쿠스틱기타. 직접 배워보시겠어요? 초보자, 중급자, 고급자 실력별 맞춤 수업이 준비되어 있습니다. 어서 참여해보세요!</p>
								<span><a href="courses.do" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
							</div>
						</div>
					</div>
					<div class="col-md-6 animate-box">
						<div class="course">
							<a href="#" class="course-img" style="background-image: url(images/vio_2.jpg);">
							</a>
							<div class="desc">
								<h3><a href="#">초보자도ok! 바이올린</a></h3>
			...
			<div class="container">
				<div class="row row-pb-md">
					<div class="col-md-3 fh5co-widget">
						<h3>Village Symphony</h3>
						<p>Village Symphony, a customized music tutoring search site. The instructor registers the lecture by determining the available time, day of the week, and price of the lecture. Students can answer 4 questions and get recommended lectures that suit them. </p>
					</div>

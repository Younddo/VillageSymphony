	...
	<!-- 분할 끝 -->    
			...
			<div class="container-fluid">
				...
				<div class="input-group">			
					...
					<div class="input--style-4" id="check"></div>
					<button class="btn btn-primary" onClick="deleteCheck();" style='font-size:20px;'>삭제</button>
				</div>
			</div>
			<!-- 달력 진짜 끝 -->
			                    
    <div class="btnbox">
    <button type="button" class="btn btn-primary" onclick="history.back()" style='font-size:20px;'>목록</button>
    <button type="button" class="btn btn-primary" onclick="cart();" style='font-size:20px;'>장바구니</button>                        
    </div>
			...
			<div class="row row-pb-md">
				...
				<div class="col-md-2 col-sm-4 col-xs-6 col-md-push-1 fh5co-widget">
					...
					<ul class="fh5co-footer-links">
						...
						<li><a href="lessoncreate.do">강사등록</a></li>
					</ul>
				</div>
				<div class="col-md-2 col-sm-4 col-xs-6 col-md-push-1 fh5co-widget">
					<h3>board</h3>

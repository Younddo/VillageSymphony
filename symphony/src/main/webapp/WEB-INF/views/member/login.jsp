...
*/
		...
		out.println("<div class='container-login100'>");
        out.println("<div class='wrap-login100'>");
        out.println("<form class='login100-form validate-form p-l-55 p-r-55 p-t-178'>");
        out.println("<div class='login100-form-title'>" +s_id + "</class> 님");
        out.println("</div>");
        out.println("<div class='container-login101-form-btn'>");
        out.println("<button class='btn btn-primary'> <a href='logoutproc.do' style='color : #fff;'> 로그아웃 </a> </button>");
        out.println("</div>");
        out.println("<br><br>");
        out.println("<div class='container-login101-form-btn'>");
        out.println("<button class='btn btn-primary'> <a href='modify.do' style='color : #fff;'> 회원정보수정  </a> </button>");
        out.println("</div>");
        out.println("<br><br>");
        out.println("<div class='container-login101-form-btn'>");
        out.println("<button class='btn btn-primary'><a href='userdelete.do' style='color : #fff;'> 회원탈퇴 </a> </button>");
        out.println("</div> ");
        out.println("<br><br>");
        out.println("</form>");
        out.println("</div>");
